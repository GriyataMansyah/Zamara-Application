                        ...
                        <div>
                            ...
                            <li class="nav-item">
                                    ...
                                    <ion-icon name="home-outline" class="ion-icon" href="../12. Dashboard/Dashboard.php"></ion-icon><span
                                            class="icon-text d-none" href="../12. Dashboard/Dashboard.php">DASHBOARD</span>
                                    </a>
                                </li>
                                <li class="nav-item">
    ...
    <div class="wrapper d-none d-md-block">
        ...
        <table class="hey31">
            ...
            <tr>
                ...
                <td class="hey17">:</td>
                <td class="hey18">
                    <select id="roleSelect" name="role" class="form-control custom-width" onchange="updateFormAction()" required>
        ...
        <tr>
            ...
            <td class="hey17">:</td>
            <td class="hey18">
                <select name="warga_negara" class="form-control custom-width" required>
                    <option value=""selected></option>
                    ...
                    <option value="indonesia">Indonesia</option>
                                  ...
                                  <tr>
                                    ...
                                    <td class="hey17">:</td>
                                    <td class="hey18"><input type="text" name="username" class="form-control custom-width" required></td>
                                  </tr>
                                  <tr>
                                    <td class="hey17">Password</td>
                                    <td></td>
                                    <td class="hey17">:</td>
                                    <td class="hey18"><input type="password" name="password" class="form-control custom-width" id="passwordInput" value="12345" required></td>
                                  </tr>
                                  <tr>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td><input type="checkbox" onclick="togglePassword()"> Perlihatkan Password</td>
                                  </tr>
                                  <tr>
                                    <td class="hey17">NIK</td>
                                    <td></td>
                                    <td class="hey17">:</td>
                                    <td class="hey18"><input type="number" name="nik" class="form-control custom-width "required></td>
                                  </tr> <tr>
                                    <td class="hey17">Nama</td>
                                    <td></td>
                                    <td class="hey17">:</td>
                                    <td class="hey18"><input type="text" name="nama" class="form-control custom-width" required></td>
                                  </tr> <tr>
                                    <td class="hey17">No Hp</td>
                                    <td></td>
                                    <td class="hey17">:</td>
                                    <td class="hey18"><input type="number" name="no_hp"class="form-control custom-width" required></td>
                                  </tr><tr>
                                    <td class="hey17">Alamat</td>
                                    <td></td>
                                    <td class="hey17">:</td>
                                    <td class="hey18"><input type="text" name="alamat" class="form-control custom-width" required></td>
                                  </tr><tr>
                                    <td class="hey17">Tanggal Lahir</td>
                                    <td></td>
                                    <td class="hey17">:</td>
                                    <td class="hey18"><input type="date" name="tgl_lahir" class="form-control custom-width" required></td>
                                  </tr>
                                </table>
...
<main role="main" class="col-md-12 d-block d-md-none">
        ...
        <table class="hey31">
            ...
            <tr>
                ...
                <td class="hey17">:</td>
                <td class="hey18">
                    <select id="roleSelect2" name="role" class="form-control custom-width" onchange="updateFormAction2()">
                        <option value=""selected></option>
                        <option value="admin">Admin</option>
                        <option value="masyarakat" >Masyarakat</option>
                        <option value="rt_rw">RT/RW</option>
        ...
        <tr>
            ...
            <td class="hey18">
                <select name="warga_negara" class="form-control custom-width">
                    ...
                    <option value="indonesia">Indonesia</option>
                                  ...
                                  <tr>
                                    ...
                                    <td></td>
                                    <td class="hey17">:</td>
                                    <td class="hey18"><input type="password" name="password" class="form-control custom-width" id="passwordInput2"></td>
                                  </tr>
                                  <tr>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td><input type="checkbox" onclick="togglePassword2()"> Lihat Password</td>
                                  </tr>
                                  <tr>
                                    <td class="hey17">NIK</td>
                                    <td></td>
                                    <td class="hey17">:</td>
                                    <td class="hey18"><input type="number" name="nik" class="form-control custom-width"></td>
                                  </tr> <tr>
                                    <td class="hey17">Nama</td>
                                    <td></td>
                                    <td class="hey17">:</td>
                                    ...
                                    <td></td>
                                    <td class="hey17">:</td>
                                    <td class="hey18"><input type="number" name="no_hp"class="form-control custom-width"></td>
                                  </tr><tr>
                                    <td class="hey17">Alamat</td>
                                    <td></td>
                                    <td class="hey17">:</td>
                ...
                <script>
        function updateFormAction2() {
            var roleSelect = document.getElementById('roleSelect2');
