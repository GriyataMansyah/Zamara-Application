...
<body class="body">
    ...
    <div class="wrapper">
        ...
        <form action="simpan_security.php" method="post">
                                <table class="hey31">
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td></td>
                                    <td class="hey17">:</td>
                                    <td class="hey18"><input type="text" name="role" value="security" class="form-control custom-width"></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    <td class="hey17">security.id</td>
                                    <td></td>
                                    <td class="hey17">:</td>
                                    <td class="hey18"><input type="text" name="security_id" class="form-control custom-width"></td>
                                  </tr> <tr>
    ...
    <script>
        function showInput() {
            ...
            // Menyembunyikan semua elemen input terlebih dahulu
            ...
            // Menampilkan elemen input yang sesuai dengan opsi yang dipilih
            if (selectedOption === "option1") {
                document.getElementById("input1").classList.remove("hidden");
            } else if (selectedOption === "masyarakat") {
                document.getElementById("input2").classList.remove("hidden");
            } else if (selectedOption === "rt_rw") {
    ...
    <script>
        document.getElementById('showPassword').addEventListener('change', function() {
          var passwordInput = document.getElementById('1');
          passwordInput.type = this.checked ? 'text' : 'password';
        });
      </script>
      <script>
        document.getElementById('showPassword3').addEventListener('change', function() {
          var passwordInput = document.getElementById('2');
          passwordInput.type = this.checked ? 'text' : 'password';
        });
      </script>
      <script>
        document.getElementById('showPassword4').addEventListener('change', function() {
          var passwordInput = document.getElementById('3');
          passwordInput.type = this.checked ? 'text' : 'password';
        });
      </script>
      <script>
        document.getElementById('showPassword5').addEventListener('change', function() {
          var passwordInput = document.getElementById('4');
          passwordInput.type = this.checked ? 'text' : 'password';
        });
      </script>
