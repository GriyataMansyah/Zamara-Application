...
<body class="body">
    ...
    <div class="wrapper">
        ...
        <form action="simpan_rt_rw.php" method="post">
                                <table class="hey31">
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td></td>
                                    <td class="hey17">:</td>
                                    <td class="hey18"><input type="text" name="role" value="rt_rw" class="form-control custom-width"></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    <td class="hey17">TW.id</td>
                                    <td></td>
                                    <td class="hey17">:</td>
                                    <td class="hey18"><input type="text" name="tw_id" class="form-control custom-width"></td>
                                  </tr> <tr>
