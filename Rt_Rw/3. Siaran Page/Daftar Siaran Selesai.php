                                ...
                                <li class="nav-item">
                                    <a class="nav-link hey3" href="../3. Siaran Page/Daftar Siaran.php">
                                        <ion-icon name="barcode-outline" class="ion-icon" href="../9. Profile Page/Profile Page.php"></ion-icon></ion-icon><span
                                            class="icon-text" href="../3. Siaran Page/Daftar Siaran.php">SIARAN BERLANGSUNG</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                <a class="nav-link hey3" href="../3. Siaran Page/Daftar Siaran Selesai.php"">
                                <ion-icon name="caret-forward-outline" class="ion-icon" href="../3. Siaran Page/Daftar Siaran Selesai.php"></ion-icon><span
                                            class="icon-text" href="../3. Siaran Page/Daftar Siaran Selesai.php">SIARAN SELESAI</span>
                                    </a>
                            </li>
                            </ul>
                        </div>
                    ...
                    <div class="sidebar-sticky">
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link hey3" href="../3. Siaran Page/Daftar Siaran Selesai.php"">
                                <ion-icon name="caret-forward-outline" class="ion-icon" href="../3. Siaran Page/Daftar Siaran Selesai.php"></ion-icon><span
                                            class="icon-text d-none d-xl-block" href="../3. Siaran Page/Daftar Siaran Selesai.php">SELESAI</span>
                                    </a>
                            </li>
                        </ul>
                    </div>
                ...
                <main role="main" class="col-md-10 ml-sm-auto col-lg-10 px-4">
                    ...
                    <div class="content">
                        <div class="report-heading hey11">
                            <h2 class="hey9"> DAFTAR SIARAN (SELESAI)</h2>
                            <a href="../4. Form Siaran Page/Form Siaran.php" class="btn btn-primary hey9" id="hey10 d-none d-xl-block">BUAT PESAN</a>
                        </div>
...
$query = mysqli_query($koneksi, "SELECT * FROM tb_siaran WHERE status = 'selesai' ORDER BY tanggal DESC");
...
?>
    <form method="post" action="Siaran Belum.php">
    <div class="hey12">
            <h4><?php echo $data['judul']; ?></h4>
            <p><?php echo $data['deskripsi']; ?></p>
            <p class="text-end"><?php echo $data['tanggal']; ?></p>
            <input type="hidden" name="siaran_id" value="<?php echo $data['siaran_id']; ?>"> 
            <input type="hidden" name="status" value="belum">  
            <button class="btn btn-secondary hey20" type="submit">SIARAN BELUM SELESAI</button>
        </div>
<?php
}
?>
