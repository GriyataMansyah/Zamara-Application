...
<body class="body">
                ...
                <main role="main" class="col-md-10 ml-sm-auto col-lg-10 px-4">
                    ...
                    <div class="content">
                        <div class="report-heading hey11">
                            <h2 class="mx-auto d-block"> BUAT LAPORAN</h2>
                        </div>
                        ...
                        <div class="all-elements">
                            ...
                            <form method="post" action="simpan_laporan.php">
                                ...
                                <input class="hidden"type="text" name="jenis" placeholder="" value="tidak darurat">
                                  ...
                                  <tr>
                                    <td class="hey17">Lokasi</td>
                                    <td></td>
                                    <td class="hey17">:</td>
                                    <td class="hey18"><input type="text" name="lokasi"class="form-control custom-width"></td>
                                  </tr>
                                </table>
    ...
    <!-------------------------------------------------- UPDATE TERBARU --------------------------------------->
    <main role="main" class="col-md-12 d-block d-md-block">
                    ...
                    <div class="content">
                        ...
                        <div class="all-elements">
                            ...
                            <form method="post" action="simpan_laporan.php" class="form2">
                                <table>
                                <input class="hidden"type="text" name="username" placeholder="Masukkan akun_id" value="<?php echo $_SESSION['user'];?>">
                                <input class="hidden"type="text" name="jenis" placeholder="" value="tidak darurat">
                                  <tr>
