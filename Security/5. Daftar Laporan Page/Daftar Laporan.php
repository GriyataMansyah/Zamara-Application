...
?>
    <form method="post" action="Tidak Terima.php">
        <div class="hey12">
            ...
            <input type="text" class="hidden" name="id" value="<?php echo $id_laporan; ?>">
            <button type="submit" class="btn btn-danger hey22"> TANGGUHKAN </button>
        </div>
<?php
}
?>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title mx-auto d-block" id="exampleModalLabel">PILIH JENIS LAPORAN</h5>
      </div>
