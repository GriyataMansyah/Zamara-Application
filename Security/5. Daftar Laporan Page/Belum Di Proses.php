                    ...
                    <div class="offcanvas-body hey8">
                        <div>
                            ...
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                <a class="nav-link hey3" href="Belum Di Proses.php">
                                <ion-icon name="caret-forward-outline" class="ion-icon" href="Belum Di Proses.php"></ion-icon><span
                                            class="icon-text" href="Belum Di Proses.php">BELUM DI PROSES</span>
                                    </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link hey3" href="Tangguhkan.php">
                                <ion-icon name="caret-forward-outline" class="ion-icon" href="Tangguhkan.php"></ion-icon><span
                                            class="icon-text" href="Tangguhkan.php">TANGGUHKAN</span>
                                    </a>
                            </li>
                                <li class="nav-item">
                    ...
                    <div class="sidebar-sticky">
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link hey3" href="Belum Di Proses.php">
                                <ion-icon name="caret-forward-outline" class="ion-icon" href="Belum Di Proses.php"></ion-icon><span
                                            class="icon-text d-none d-xl-block" href="Belum Di Proses.php">BELUM DI PROSES</span>
                                    </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link hey3" href="Tangguhkan.php">
                                <ion-icon name="caret-forward-outline" class="ion-icon" href="Tangguhkan.php"></ion-icon><span
                                            class="icon-text d-none d-xl-block" href="Tangguhkan.php">TANGGUHKAN</span>
                                    </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link hey3" href="../3. Siaran Page/Daftar Siaran.php">
                ...
                <main role="main" class="col-md-10 ml-sm-auto col-lg-10 px-4">
                    ...
                    <div class="content">
                        <div class="report-heading hey11">
                            <h2 class="hey9 mx-auto"> DAFTAR LAPORAN (BELUM DI PROSES)</h2>
                        </div>
...
$query = mysqli_query($koneksi, "SELECT * FROM tb_laporan WHERE status = 'proses' ORDER BY tgl_waktu DESC");

if (!$query) {
    die('SQL Error: ' . mysqli_error($koneksi, "SELECT * FROM tb_laporan WHERE status = 'proses' ORDER BY tgl_waktu DESC"));
}
    ...
    <form method="post" action="Terima.php">
        <div class="hey12">
            <a href="../10. Komentar Laporan Page/Komentar Laporan.php?id=<?php echo $id_laporan; ?>">
                ...
                <p class="text-end"></p>
                <input type="text" class="hidden" name="id_laporan" value="<?php echo $id_laporan; ?>">
                <button class="btn btn-primary hey22" type="submit" name="button1"> TERIMA </button>
                <button class="btn btn-danger hey22" name="button2"> TANGGUHKAN </button>
            </a>
        </div>
<?php
}
